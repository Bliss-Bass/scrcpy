...
*/
            ...
            if (audio) {
                ...
                Streamer audioStreamer = new Streamer(null, audioCodec, options.getSendStreamMeta(), options.getSendFrameMeta());
            ...
            if (video) {
                Streamer videoStreamer = new Streamer(null, options.getVideoCodec(), options.getSendStreamMeta(),
